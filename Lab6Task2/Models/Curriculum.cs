...
namespace Lab5.Models
{
    public abstract class Curriculum:IFile
    {
        ...
        public void FileInformationRead(List<Lecture> lectures)
        {
            string reader;
            string[] stringArray;
            using (StreamReader streamReader=new StreamReader("E:text1.txt"))
            {
        ...
        {
            using (StreamWriter studentInformationWriter=new StreamWriter("E:text1.txt"))
            {
        ...
        public void FileInformationEdit(List<Lecture> lectures)
        {
            ...
            File.WriteAllText("E:text1.txt", String.Empty);
            using (StreamWriter sw=new StreamWriter("E:text1.txt")){
